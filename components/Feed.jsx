...
const Feed = () => {
  ...
  return (
    <div className='feed px-5 py-3 w-[60%] overflow-y-scroll'>
      ...
      {Posts.map((p) => (
        <div key={p.username} className="post min-w-[500px] h-auto mx-auto my-4 py-5 px-3 border-[1px] border-[#ffffff33] rounded-lg">
          ...
          <div className="header flex w-full justify-between items-center">
            <div className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm text-gray-400 px-3">{p.time}</span>
            </div>
          ...
          <div className="info flex flex-col gap-2 py-3">
            <p className="text-xl font-semibold">{p.caption}</p>
            <Image width={600} height={400} className="max-w-[600px] mx-auto h-auto rounded-lg" src={p.img} alt="sedan" />
          </div>

          <div className="buttons flex items-center justify-between gap-3 mt-3">
